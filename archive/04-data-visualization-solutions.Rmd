...
```{r}
ggplot(data,aes(dwt,dht, color = ded_lbls)) + geom_point() + scale_color_viridis_d(option = "inferno") + labs (title = "Fathers' weight vs height based on education level", x = "Weight (pounds)", y = "Height (inches)", color = "Education levels")
```
...
```{r}
ggplot(data,aes(dwt,dht, color = ded_lbls)) + geom_point() + scale_color_viridis_d(option = "inferno") + labs (title = "Fathers' weight vs height based on education level", x = "Weight (pounds)", y = "Height (inches)", color = "Education levels") + theme_classic() + facet_wrap(~ded_lbls)
```
